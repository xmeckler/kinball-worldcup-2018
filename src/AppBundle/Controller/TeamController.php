...
class TeamController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $file = $team->getFlagImg();

            $fileName = $this->generateUniqueFileName().'.'.$file->guessExtension();

            // moves the file to the directory where flag images are stored
            $file->move(
                $this->getParameter('flagImages_directory'),
                $fileName
            );

            // updates the 'flagImg' property to store the PDF file name
            // instead of its contents
            $team->setFlagImg($fileName);
